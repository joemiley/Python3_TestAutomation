...
dir_path = r'screenShots/mainMenuButtonsBase\base'
...
def log():
    f = open('1.logsBase.txt', 'w')
    with f:
        for k in range(0, len(log_event_list)):
            f.write("Baselog"+str(log_event_list[k].counter)+" |"+"mouse_position"+str(log_event_list[k].mouse_x)+"," +
